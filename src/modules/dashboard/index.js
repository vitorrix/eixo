...
export function render(container) {
  ...
  const tarefasWrap = el('div', { class: 'tarefa-widget-wrap' })
  ...
  mount(container,
    ...
    el('div', { class: 'dashboard-section' }, tarefasWrap),
  ...
  const unsubTarefas = subscribeTarefas(
    lista => { mount(tarefasWrap, buildTarefasWidget(lista, profile?.uid)) },
