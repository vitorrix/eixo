...
Campos de cada item:
- produtoBruto: nome do produto incluindo a capacidade de armazenamento se houver (ex: "iPhone 17 Pro Max 256GB", "Watch S11 42MM", "iPad 11 128GB"). NUNCA inclua a palavra "Apple" no nome — é redundante (todo produto aqui já é Apple). Ex: "Apple Watch Ultra 3 49MM" vira "Watch Ultra 3 49MM"; "Apple Pencil Pro" vira "Pencil Pro"; "Apple AirTag 4 Pack" vira "AirTag 4 Pack". Mantenha o resto do nome intacto. NUNCA inclua a origem/mercado do aparelho aqui (ver campo "origem" abaixo). IMPORTANTE — MacBook/iMac/Mac mini/Mac Studio/Mac Pro costumam especificar RAM e armazenamento (SSD) juntos, em formatos variados ("24GB | 512GB", "24GB/512GB", "16GB 512GB SSD"). Inclua SEMPRE os DOIS números em produtoBruto, na mesma ordem em que aparecem no texto original (ex: "MACBOOK PRO M5 14” 24GB | 512GB" vira produtoBruto "MacBook Pro M5 14\" 24GB 512GB"). Se o mesmo cabeçalho de Mac listar mais de uma combinação de RAM+armazenamento com preços diferentes (ex: 24GB|512GB por R$13.990 e 24GB|1TB por R$14.250), gere um item por combinação — mesmo que a RAM seja igual entre elas — do mesmo jeito que cores diferentes geram itens separados. NUNCA omita o número de armazenamento de um Mac quando ele aparecer no texto, mesmo que a RAM já tenha sido mencionada. IMPORTANTE — "MacBook Neo" é um modelo real e distinto de "MacBook Pro"/"MacBook Air": quando o texto disser "NEO" (ex: "MACBOOK NEO 13\" 8GB 256GB"), preserve exatamente "MacBook Neo", NUNCA leia/corrija como "MacBook Pro" — é sempre vendido com 8GB de RAM fixo. IMPORTANTE — "CPO" quando aparecer no texto (ex: "iPhone 16 128GB CPO") deve ficar preservado no final do produtoBruto (ex: "iPhone 16 128GB CPO") — é uma variante de caixa/embalagem do aparelho, não pode ser omitido nem absorvido como sinal de condição (ver campo "seminovo" abaixo), e sem ele um item CPO colide com o mesmo modelo/cor sem CPO.
- cor: a cor/variante específica (ex: "Azul", "Preto", "Space Black"). String vazia se não houver cor definida.
- origem: o mercado/região de procedência do aparelho, quando indicado (ex: "Americano", "Japonês", "Indiano", "Árabe", "Chinês", "Europeu"). Reconheça tanto o nome por extenso quanto códigos de modelo da Apple: LL/A ou US = Americano; J/A = Japonês; ZP/A = Indiano; KH/A ou A/A = Árabe/Emirados; CH/A = Chinês; B/A = Europeu. Isso é uma dimensão SEPARADA de seminovo e de CPO — um aparelho pode ser, por exemplo, "CPO americano" e ainda assim ser novo/lacrado. String vazia se a origem não for indicada. IMPORTANTE: dois itens do mesmo produto/cor mas origens diferentes são ofertas DISTINTAS com preços possivelmente diferentes — nunca as junte nem descarte a origem de uma delas.
- preco: valor numérico em reais, sem formatação, sem "R$", sem separador de milhar (ex: 6500, não "R$ 6.500" nem "6.500,00")
- seminovo: true se ESSE item específico for usado/seminovo, false se for novo/lacrado. Sinais de seminovo: palavras "seminovo"/"semi-novo"/"semi novo"/"usado"/"vitrine"/"outlet", classificação por grade de bateria ("GRADE A"/"GRADE B"/"GRADE AB") ou percentual de bateria ("Bateria acima de X%", "🔋90+", "🔋85-89" etc). Sinais de novo/lacrado: palavras "lacrado"/"novo"/"selado", "🔒LACRADO🔒", ausência de qualquer sinal de uso. IMPORTANTE — "CPO" NÃO é sinal de seminovo neste negócio (é uma variante de caixa do aparelho NOVO, ver campo "produtoBruto" acima) — NUNCA marque seminovo=true só por causa de "CPO"; um item "CPO" sem nenhum outro sinal textual de uso é seminovo=false. NÃO use emojis genéricos (♻️ ou similares) como sinal de seminovo — vários fornecedores usam esse tipo de emoji só como marcador decorativo de lista, na frente de item novo ou usado indistintamente; conte apenas com palavras/marcadores textuais inequívocos. IMPORTANTE: uma mesma mensagem pode ter produtos lacrados E seminovos misturados em seções diferentes — classifique cada item individualmente pelo contexto mais próximo dele, não pela mensagem inteira. Na dúvida (nenhum sinal textual em nenhuma direção), use false.
